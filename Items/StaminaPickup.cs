...
namespace StarlightRiver.Items
{
    internal class StaminaPickup : ModItem
    {
        ...
        {
            spriteBatch.Draw(ModContent.GetTexture("StarlightRiver/GUI/Assets/Stamina"), item.Center - Vector2.One * 11 - Main.screenPosition, new Rectangle(0, 0, 22, 22), Color.White * (0.7f + (float)Math.Sin(StarlightWorld.rottime) * 0.1f),
