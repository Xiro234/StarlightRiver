...
namespace StarlightRiver.Items.Vitric
{
    ...
    public class AncientSandstoneItem : QuickTileItem {
        public AncientSandstoneItem() : base("Ancient Sandstone Brick", "", ModContent.TileType<Tiles.Vitric.AncientSandstone>(), 0)
        {
        }
    }

    public class AncientSandstonePlatformItem : QuickTileItem {
        public AncientSandstonePlatformItem() : base("Ancient Sandstone Platform", "", ModContent.TileType<Tiles.Vitric.AncientSandstonePlatform>(), 0)
        {
        }
    }
