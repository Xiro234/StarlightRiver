...
namespace StarlightRiver.NPCs.Boss.VitricBoss
{
    internal class SandCone : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                for (int k = 0; k < 100; k++) Dust.NewDustPerfect(projectile.Center, DustType<Dusts.Sand>(), new Vector2(Main.rand.NextFloat(-20f, 0), 0).RotatedBy(projectile.rotation + Main.rand.NextFloat(-0.2f, 0.2f)), Main.rand.Next(50, 150));
