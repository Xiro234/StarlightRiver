        ...
        public override void AI()
        {
            ...
            if (animate >= 1)
            {
                ...
                if (animate == 1)
                {
                    ...
                    StarlightRiver.Instance.abilitytext.Display("Zzelera's Cloak", "Press " + StarlightRiver.Superdash.GetAssignedKeys()[0] + " to become invincible and fly to your mouse", mp.sdash);
                }
            }
