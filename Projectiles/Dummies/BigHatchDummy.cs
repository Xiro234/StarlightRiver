...
namespace StarlightRiver.Projectiles.Dummies
{
    ...
    {
        public BigHatchDummy() : base(ModContent.TileType<Tiles.Overgrow.BigHatchOvergrow>(), 16, 16) { }
        public override void Update()
        {
            ...
            if (Main.rand.Next(5) == 0)
            {
                ...
                Dust.NewDustPerfect(projectile.Center, ModContent.DustType<Dusts.Gold4>(),
