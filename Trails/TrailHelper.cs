...
namespace StarlightRiver.Trails
{
    public class TrailManager
    {
        ...
        public void DoTrailCreation(Projectile projectile)
        {
            ...
            if (projectile.type == mod.ProjectileType("StarWShard"))
            {
                CreateTrail(projectile, new StandardColorTrail(new Color(218, 94, 255)), new RoundCap(), new StarWShardTrailPosition(), 8f, 250f);
            }
            if (projectile.type == ModContent.ProjectileType<TrailTest1>())
            {
                CreateTrail(projectile, new GradientTrail(new Color(255, 215, 105), new Color(105, 213, 255)), new RoundCap(), new StarWShardTrailPosition(), 14f, 150f, new ImageShader(mod.GetTexture("Textures/Trails/Trail_2"), 0.01f, 1f, 1f));
                CreateTrail(projectile, new GradientTrail(new Color(255, 215, 105) * .5f, new Color(105, 213, 255) * .5f), new RoundCap(), new StarWShardTrailPosition(), 56f, 250f, new DefaultShader());
                CreateTrail(projectile, new StandardColorTrail(Color.White * 0.3f), new RoundCap(), new StarWShardTrailPosition(), 12f, 80f, new DefaultShader());
                CreateTrail(projectile, new StandardColorTrail(Color.White * 0.3f), new RoundCap(), new StarWShardTrailPosition(), 12f, 80f, new DefaultShader());
                CreateTrail(projectile, new StandardColorTrail(Color.White * 0.2f), new RoundCap(), new StarWShardTrailPosition(), 56f, 30f, new DefaultShader());

            }
            if (projectile.type == ModContent.ProjectileType<TrailTest2>())
            {
                switch (Main.rand.Next(3))
                {
                    case 0:
                        CreateTrail(projectile, new StandardColorTrail(new Color(115, 220, 255)), new RoundCap(), new StarWShardTrailPosition(), 8f, 100f, new ImageShader(mod.GetTexture("Textures/Trails/Trail_2"), 0.01f, 1f, 1f));
                        break;
                    case 1:
                        CreateTrail(projectile, new StandardColorTrail(new Color(255, 231, 145)), new RoundCap(), new StarWShardTrailPosition(), 8f, 100f, new ImageShader(mod.GetTexture("Textures/Trails/Trail_2"), 0.01f, 1f, 1f));
                        break;
                    case 2:
                        CreateTrail(projectile, new StandardColorTrail(new Color(255, 128, 244)), new RoundCap(), new StarWShardTrailPosition(), 8f, 100f, new ImageShader(mod.GetTexture("Textures/Trails/Trail_2"), 0.01f, 1f, 1f));
                        break;
                }
            }
            if (projectile.type == ModContent.ProjectileType<TrailTest3>())
            {
                CreateTrail(projectile, new RainbowTrail(5f, 0.002f, 1f, .75f), new RoundCap(), new StarWShardTrailPosition(), 150f, 130f, new ImageShader(mod.GetTexture("Textures/Trails/Trail_1"), 0.01f, 1f, 1f));
            }
        ...
        {
            Mod mod = ModContent.GetInstance<StarlightRiver>();
            if (projectile.type == ModContent.ProjectileType<StarWShard>() || projectile.type == ModContent.ProjectileType<TrailTest1>() || projectile.type == ModContent.ProjectileType<TrailTest2>() || projectile.type == ModContent.ProjectileType<TrailTest3>())
            {
                StarlightRiver.TrailManager.TryEndTrail(projectile, Math.Max(15f, projectile.velocity.Length() * 3f));
            }
    ...
    public class StarWShardTrailPosition : ITrailPosition
    {
        public Vector2 GetNextTrailPosition(Projectile projectile)
        {
