...
namespace StarlightRiver.Tiles.Forest
{
    public class LeafWall : ModWall
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            {
                Texture2D tex = ModContent.GetTexture("StarlightRiver/Tiles/Forest/LeafWallFlow");

                float offset = i * j % 6.28f;
                float sin = (float)Math.Sin(LegendWorld.rottime + offset);
                ...
                {
                    Texture2D tex2 = ModContent.GetTexture("StarlightRiver/Tiles/Forest/LeafWallFlower");
