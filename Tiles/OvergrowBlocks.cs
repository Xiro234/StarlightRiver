...
namespace StarlightRiver.Tiles
{
    ...
    class VineOvergrow : ModTile
    {
        ...
        public override void DrawEffects(int i, int j, SpriteBatch spriteBatch, ref Color drawColor, ref int nextSpecialDrawIndex)
        {
            ...
            spriteBatch.Draw(ModContent.GetTexture("StarlightRiver/Tiles/VineOvergrowFlow"), new Vector2(i + 12, j + 12) * 16 - Main.screenPosition + new Vector2((float)Math.Sin((i % 4 * 1.57f)+LegendWorld.rottime + j % 6.28f) * sway, 0), new Rectangle((j % 2) * 16, 0, 16, 16), drawColor);
        }
    }
    ...
    class TallgrassOvergrow : ModTile
    {
        ...
        public override void DrawEffects(int i, int j, SpriteBatch spriteBatch, ref Color drawColor, ref int nextSpecialDrawIndex)
        {
            spriteBatch.Draw(ModContent.GetTexture("StarlightRiver/Tiles/TallgrassOvergrowFlow"), new Rectangle(((i + 12) * 16) - (int)Main.screenPosition.X + 8, ((j + 13) * 16) - (int)Main.screenPosition.Y + 2, 16, 16), new Rectangle((i % 2) * 16, 0, 16, 16), drawColor, (float)Math.Sin(LegendWorld.rottime + i % 6.28f) * 0.25f, new Vector2(8, 16), 0, 0);
        }
    }
}
