...
namespace StarlightRiver.Tiles.Vitric
{
    internal class VitricCrystalBig : ModWall
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(tex, (new Vector2(i, j) + Helper.TileAdj) * 16 - Main.screenPosition, tex.Frame(), Color.White * (0.7f + (float)Math.Sin(StarlightWorld.rottime + (i * 0.06f)) * 0.2f), 0, Vector2.Zero, 1, 0, 0);
        }
    }
