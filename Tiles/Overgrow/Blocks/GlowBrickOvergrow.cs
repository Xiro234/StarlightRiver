...
namespace StarlightRiver.Tiles.Overgrow.Blocks
{
    ...
    internal class GlowBrickOvergrowItem : QuickTileItem {
        public GlowBrickOvergrowItem() : base("Awoken Runic Bricks", "They have a pulse...", TileType<GlowBrickOvergrow>(), 1)
        {
        }
    }
}